  ...
  return (
    <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
      <div className="flex justify-start item-start space-y-2 flex-col">
        <h1 className="text-3xl dark:text-black lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">{orderId}</h1>
      ...
      <div className="mt-10 flex flex-col xl:flex-row justify-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
        ...
        {Array.isArray(order.products) && order.products.length > 0 ? (
                        ...
                        <p className="text-base dark:text-white xl:text-lg font-semibold leading-6 text-gray-800">
                           {Number(product.price)*Number(product.quantity)}.000đ
                        </p>
                    </div>
                                        </div>
                                    </div>
                        ...
                        <p className="text-base dark:text-gray-300 leading-6 text-gray-600">
                            No products found.
                        </p>
                    )}
